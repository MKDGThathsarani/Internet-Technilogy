...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize Resources components (always available)
    initResourceFilters();
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.section-title, .section-subtitle, .skill-progress, .stat-number, .project-card, .timeline-content, .certification-card, .download-card, .github-repo, .publication-card, .blog-card').forEach(el => {
        observer.observe(el);
    });
}
...
// ============================================================
// RESOURCES FILTERS - UPDATED FOR NEW BLOG CATEGORIES
// ============================================================
function initResourceFilters() {
    ...
    // Blog filters - Updated for new categories
    ...
    blogFilterButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            blogCards.forEach(card => {
                // Get all categories from the card
